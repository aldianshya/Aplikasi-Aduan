...
class DetailAduanSiswa extends StatelessWidget {
  final String judulAduan;
  DetailAduanSiswa({required this.judulAduan});
    ...
    onPressed: () {
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          String responguru = aduanData['responwali'] ?? 'Belum ada respon';
          String responwali = aduanData['responguru'] ?? 'Belum ada respon';
