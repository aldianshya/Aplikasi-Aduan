...
class DetailAduanGuru extends StatelessWidget {
  final String judulAduan;
  DetailAduanGuru({required this.judulAduan});
    ...
    onPressed: () {
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          String namaPeresponWali = aduanData['namaPeresponGuru'] ?? 'N/A';
          String namaPeresponGuru = aduanData['namaPeresponWali'] ?? 'N/A';
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ResponGuru(judulAduan: judulAduan),
                      ),
                    );
                  },
                  child: Text(
