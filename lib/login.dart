...
class _LoginPageState extends State<LoginPageSiswa> {
  ...
  try {
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => HomeSiswa(email: emailController.text.trim())),
    );
  } catch (e) {
    ...
    // Menampilkan notifikasi ketika login gagal
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      RichText(
                        textAlign: TextAlign.start,
                        text: TextSpan(
                          text: 'Ingin login sebagai Orang Tua? ',
                          style: GoogleFonts.poppins(
                              color: Colors.black, fontSize: 14),
                          children: [
                            TextSpan(
