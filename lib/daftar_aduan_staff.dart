...
import 'package:aplikasi_aduan/detail_aduan_sftaff.dart';
import 'package:aplikasi_aduan/login.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class DaftarAduanStaff extends StatefulWidget {
  const DaftarAduanStaff({required this.email, super.key});
  final String email;
  // const DaftarAduanGuru({required this.email});

  @override
  State<DaftarAduanStaff> createState() => _HalamanDaftarAduanStaff();
}

int currentPage = 1;
final int complaintsPerPage = 4;

class _HalamanDaftarAduanStaff extends State<DaftarAduanStaff> {
  ...
  Widget build(BuildContext context) {
    ...
    Navigator.pushNamed(
      ...
      body: isLoading
          ...
          context,
          MaterialPageRoute(
            builder: (context) => DetailAduanStaff(judulAduan: complaint['judulAduan']),
          ),
        );
                                    },
                                    child: Text('Detail'),
