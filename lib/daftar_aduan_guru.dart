...
class DaftarAduanGuru extends StatefulWidget {
  const DaftarAduanGuru({required this.email, super.key});
  final String email;
  // const DaftarAduanGuru({required this.email});

  @override
  State<DaftarAduanGuru> createState() => _HalamanDaftarAduanGuru();
}

int currentPage = 1;
final int complaintsPerPage = 4;

class _HalamanDaftarAduanGuru extends State<DaftarAduanGuru> {
  ...
  Widget build(BuildContext context) {
    ...
    Navigator.pushNamed(
      ...
      body: isLoading
          ...
          context,
          MaterialPageRoute(
            builder: (context) => DetailAduanGuru(judulAduan: complaint['judulAduan']),
          ),
        );
                                    },
                                    child: Text('Detail'),
